...
exports.seed = async function(knex) {
  ...
  await knex('Item').insert([
    ...
    {id: 19, AdminID: 1, Name: 'Pyrite', Description: 'Healing', Quantity: 300, Image: 'https://media.australian.museum/media/dd/images/04_D48008_Pyrite_SH.71bc4b3.width-1200.efe3c9f.jpg'}
  ]);
};